...
& $archdev tasks guide --help *> $null
if ($LASTEXITCODE -ne 0) {
    [Console]::Error.WriteLine("Updating ArchDev because this version lacks the Tasks domain.")
...
& $archdev tasks guide --help *> $null
if ($LASTEXITCODE -ne 0) { throw "Installed ArchDev does not provide the Tasks domain" }
